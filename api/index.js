...
// Simulasi database untuk history percakapan (menggunakan Map untuk Vercel)
...
const GEMINI_API_KEY = process.env.GEMINI_API_KEY || "AIzaSyBJ1QqJvwefQH3MVnjxxT0y3fYJhZu3RmI";
...
async function chatWithBarista(userId, message, maxRetries = 3, initialDelay = 1000) {
  ...
  // System instruction (sama seperti sebelumnya)
...
app.get('/', (req, res) => {
  res.json({ 
    message: "Reykal Coffee API is running!",
    status: "active",
